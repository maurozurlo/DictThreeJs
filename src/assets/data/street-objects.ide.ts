...
export const STREET_IDE: IDEFile = {
    ...
    objs: [
        ...
        { id: 2016, modelName: 'env_streetlight_standard_medium', asset: 'models/env_streetlight_standard_medium.glb', visibleIf: { tab: 'Street', infrastructure: [4, 10] }, textures: [{ texture: 'textures/streetlight.png', transparent: false }] },

        { id: 2017, modelName: 'env_tree_medium', asset: 'models/env_tree_medium.glb', visibleIf: { tab: 'Street', infrastructure: [4, 10] }, textures: [{ texture: 'textures/leaves.png', transparent: true }, { texture: 'textures/trunk.png', transparent: false }, { texture: 'textures/treeguard.png', transparent: true }] },
        { id: 2018, modelName: 'env_parkbench_medium', asset: 'models/env_parkbench_medium.glb', visibleIf: { tab: 'Street', infrastructure: [4, 10] }, textures: [{ texture: 'textures/parkbench.png', transparent: false }] },
        { id: 2019, modelName: 'env_guard_post_small', asset: 'models/env_guard_post_small.glb', visibleIf: { tab: 'Street', security: [4, 7] }, textures: [{ texture: 'textures/guardpost.png', transparent: false }] },
        { id: 2020, modelName: 'env_tank_large', asset: 'models/env_tank_large.glb', visibleIf: { tab: 'Street', security: [8, 10] }, textures: [{ texture: 'textures/tank.png', transparent: false }] },
        { id: 2021, modelName: 'env_electricpole_medium', asset: 'models/env_electricpole_medium.glb', visibleIf: { tab: 'Street', infrastructure: [4, 10] }, textures: [{ texture: 'textures/electricpole.png', transparent: true }] },
        { id: 2022, modelName: 'env_billboard', asset: 'models/env_billboard.glb', visibleIf: { tab: 'Street' } },
        { id: 2023, modelName: 'env_scaffolding_large', asset: 'models/env_scaffolding_large.glb', visibleIf: { tab: 'Street', infrastructure: [4, 7] }, textures: [{ texture: 'textures/scaffolding.png', transparent: false }] },
        { id: 2024, modelName: 'env_gunnest_small', asset: 'models/env_gunnest_small.glb', visibleIf: { tab: 'Street', security: [8, 10] }, textures: [{ texture: 'textures/gunnest.png', transparent: false }] },
        { id: 2025, modelName: 'env_cannon_medium', asset: 'models/env_cannon_medium.glb', visibleIf: { tab: 'Street', security: [8, 10] }, textures: [{ texture: 'textures/trunk.png', transparent: false }, { texture: 'textures/cannon_wheel.png', transparent: true }] },
        { id: 2026, modelName: 'env_searchlight_large', asset: 'models/env_searchlight_large.glb', visibleIf: { tab: 'Street', security: [8, 10] }, textures: [{ texture: 'textures/spotlight.png', transparent: true }] },
        { id: 2027, modelName: 'env_graffiti_decal', asset: 'models/env_graffiti_decal.glb', visibleIf: { tab: 'Street', security: [1, 3] }, textures: [{ texture: 'textures/graffitti.png', transparent: true }] },
        { id: 2028, modelName: 'env_pothole_decal', asset: 'models/env_pothole_decal.glb', visibleIf: { tab: 'Street', infrastructure: [1, 3] }, textures: [{ texture: 'textures/pothole.png', transparent: true }] },
        { id: 2029, modelName: 'env_streetbarricade_medium', asset: 'models/env_streetbarricade_medium.glb', visibleIf: { tab: 'Street', security: [1, 3] }, textures: [{ texture: 'textures/streetbarricade.png', transparent: false }] },
        { id: 2030, modelName: 'env_camera_pole_medium', asset: 'models/env_camera_pole_medium.glb', visibleIf: { tab: 'Street', security: [4, 7] }, textures: [{ texture: 'textures/camerapole.png', transparent: false }] },
    ],
};
