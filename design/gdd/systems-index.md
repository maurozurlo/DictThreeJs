...
| [street-view.md](street-view.md) | Street View **environment** — infrastructure/security asset tiers, clickable buildings, statues (citizens moved to citizen-simulation.md) | Deferred — visual-update sprint | Sprint 6+ |
| [citizen-simulation.md](citizen-simulation.md) | 25 persistent citizens — identity, happiness, employment, role fork (thief/protestor via education for people-faction; thieves-only for army/business), death, population HUD, feedback into relations/treasury | In Review — blocking items resolved, awaiting production approval | Visual update |
| [sound-music.md](sound-music.md) | Ambient jazz music, tense state music, per-action SFX, ending themes | Draft | Sprint 6 |
