...
|---|------|------|-------------|--------|--------|
| C-001 | `char_military_rep_idle_01.glb` | Character | The General — peaked cap, medals, Sam Browne belt; Meet tab close-up; static pose; 800–1200 tri | art-bible §6.2.1 | Needed |
| C-002 | `char_business_rep_idle_01.glb` | Character | The Oligarch's Fixer — double-breasted suit, briefcase, pocket square; Meet tab close-up; static pose; 800–1200 tri | art-bible §6.2.2 | Needed |
| C-003 | `char_people_rep_idle_01.glb` | Character | The Union Man — plain work trousers, collarless shirt, flat cap; Meet tab close-up; static pose; 800–1200 tri | art-bible §6.2.3 | Needed |
| C-004 | `ped_man_slim_civilian_01.glb` | Character-Crowd | Slim male civilian base mesh; people-faction `#6b5a40`; 200–350 tri; increases at low health budget | art-bible §6.7.2; citizen-simulation §4.5 | Needed |
| C-005 | `ped_man_fit_civilian_01.glb` | Character-Crowd | Fit male civilian base mesh; people-faction `#6b5a40`; 200–350 tri; baseline civilian build | art-bible §6.7.2; citizen-simulation §4.5 | Needed |
| C-006 | `ped_man_fat_civilian_01.glb` | Character-Crowd | Fat male civilian base mesh; people-faction `#6b5a40`; 200–350 tri; increases at high health budget | art-bible §6.7.2; citizen-simulation §4.5 | Needed |
| C-007 | `ped_man_slim_army_01.glb` | Character-Crowd | Slim army ped; full-body olive-green/slate uniform `#3d4a1a`; 200–350 tri | art-bible §6.7.2 | Needed |
| C-008 | `ped_man_fit_army_01.glb` | Character-Crowd | Fit army ped; full-body olive-green/slate uniform `#3d4a1a`; 200–350 tri | art-bible §6.7.2 | Needed |
| C-009 | `ped_man_fat_army_01.glb` | Character-Crowd | Fat army ped; full-body olive-green/slate uniform `#3d4a1a`; 200–350 tri | art-bible §6.7.2 | Needed |
| C-010 | `ped_man_slim_business_01.glb` | Character-Crowd | Slim business ped; charcoal dark suit `#2a2a2a–#2a1e14`; 200–350 tri | art-bible §6.7.2 | Needed |
| C-011 | `ped_man_fit_business_01.glb` | Character-Crowd | Fit business ped; charcoal dark suit `#2a2a2a–#2a1e14`; 200–350 tri | art-bible §6.7.2 | Needed |
| C-012 | `ped_man_fat_business_01.glb` | Character-Crowd | Fat business ped; charcoal dark suit `#2a2a2a–#2a1e14`; 200–350 tri | art-bible §6.7.2 | Needed |
| C-013 | `ped_special_man_protestor.glb` | Character-Crowd | **NEW ASSET** — dedicated protestor; T-shape sign geometry (+40% height overhead); both arms raised; off-white sign face `#e8e0c0`; people-faction only; education ≥ 5 gate | citizen-simulation §3.2, §4.3; art-bible §6.4 | Needed |
...
| # | Name | Type | Description | Source | Status |
|---|------|------|-------------|--------|--------|
| E-001 | Skybox Overcast | Skybox | Grey-brown overcast sky; fog `#2a2018` | street-view §3.2; art-bible §5.4.1 | Needed |
| E-002 | Skyline Poor | Skyline silhouette | Poor-tier city skyline backdrop | street-view §3.2 | Needed |
| E-003 | Poor Apartment (cracked) | Building | Crumbling apartment facade; stucco `#5a4c38` | street-view §3.2; art-bible §7.2.3 | Needed |
| E-004 | Poor Apartment (leaning) | Building | Listing apartment block; stucco `#5a4c38` | street-view §3.2 | Needed |
| E-005 | Rundown House | Building | Single-storey deteriorating house | street-view §3.2 | Needed |
| E-006 | Improvised Market | Building | Market stall with corrugated-metal awning `#6a6860` | street-view §3.2; art-bible §7.2.3 | Needed |
| E-007 | Burned Graffitied Building | Building | Fire-damaged facade with graffiti | street-view §3.2 | Needed |
| E-008 | Dead Tree | Prop-Vegetation | Bare dead tree; 2 instances in Poor tier | street-view §3.2 | Needed |
| E-009 | Streetlight (Poor) | Prop-Furniture | Single dim streetlight; Present in Poor tier | street-view §3.2 | Needed |
| E-010 | Billboard (Poor) | Prop-Signage | 2 billboard instances in Poor tier | street-view §3.2 | Needed |
| E-011 | Empty Statue Pedestal | Prop-Decoration | Square tapered stone base `#8a8878` ~0.8u tall; clickable "A pedestal awaits its destiny."; shared across all tiers | street-view §3.2; art-bible §7.2.5 | Needed |
| E-012 | Burned Decal | Prop-Decal | Surface fire-damage decal; 8 instances | street-view §3.2 | Needed |
| E-013 | Pothole Decal | Prop-Decal | Cracked asphalt `#0d0c09` with edge `#2a2420`; 10 instances | street-view §3.2; art-bible §7.2.3 | Needed |
| E-014 | `env_trash_can_burning_small.glb` | Prop-VFX | Burning trash can; 4 instances; PointLight `#ff4400` i=0.8 d=3; UV-scroll fire plane attached | street-view §3.2; art-bible §7.2.3, §9.1 | Needed |

### Infrastructure — Normal Tier

| # | Name | Type | Description | Source | Status |
|---|------|------|-------------|--------|--------|
| E-015 | Skybox Grey | Skybox | Overcast blue-grey sky; fog `#201810` | street-view §3.2; art-bible §5.4.2 | Needed |
| E-016 | Skyline Normal | Skyline silhouette | Normal-tier city skyline backdrop | street-view §3.2 | Needed |
| E-017 | 4-Storey Apartment | Building | Standard 4-storey residential; stucco `#8a7860` | street-view §3.2 | Needed |
| E-018 | 2-Storey Residential | Building | Mid-tier house; stucco `#8a7860` | street-view §3.2 | Needed |
| E-019 | Mixed-Use Building | Building | Ground-floor commerce, upper residential | street-view §3.2 | Needed |
| E-020 | Market Building | Building | Open-fronted market structure | street-view §3.2 | Needed |
| E-021 | Government Office | Building | Boxy civic office; stucco `#8a7860` | street-view §3.2 | Needed |
...
| E-025 | `env_streetlight_standard_medium.glb` | Prop-Furniture | Dark iron pole `#2a2010`, amber lens `#c87820`; PointLight `#c87820` i=0.6 d=4; 4 instances | street-view §3.2; art-bible §7.2.3 | Needed |
...
| E-029 | Skyline Rich | Skyline silhouette | Rich-tier upscale city skyline | street-view §3.2 | Needed |
| E-030 | Luxury Tower | Building | Glass/stone luxury residential tower; stucco `#c8c0a8` | street-view §3.2 | Needed |
| E-031 | Grand Hotel | Building | Ornate multi-storey hotel | street-view §3.2 | Needed |
| E-032 | Corporate HQ | Building | Imposing office block | street-view §3.2 | Needed |
| E-033 | Luxury Mall | Building | Wide commercial building with decorative facade | street-view §3.2 | Needed |
| E-034 | Monumental Government Palace | Building | Grand civic palace dominating the block | street-view §3.2 | Needed |
| E-035 | Palm Tree | Prop-Vegetation | Tapered trunk `#6a4820`, splayed fronds `#3a5020`; 10 instances replacing Trees in Rich tier | street-view §3.2; art-bible §7.2.3 | Needed |
| E-036 | Bush (Rich) | Prop-Vegetation | Sculpted ornamental bush; 5 instances | street-view §3.2 | Needed |
| E-037 | `env_streetlight_luxury_medium.glb` | Prop-Furniture | Taller pole with decorative scroll `#c0a000`; PointLight `#c87820` i=0.7 d=4.5; 6 instances | street-view §3.2; art-bible §7.2.3 | Needed |
| E-038 | `env_fountain_large.glb` | Prop-Decoration | Tiered stone basin; water plane `#4080a0` emissive `#204060`; PointLight `#4080c0` i=0.4 d=5; 2 instances | street-view §3.2; art-bible §7.2.3 | Needed |
...
| # | Name | Type | Description | Source | Status |
|---|------|------|-------------|--------|--------|
| E-041 | `env_guard_post_small.glb` | Prop-Security | Olive-grey `#505840` rectangular booth; no glass; 2 instances at block ends | street-view §3.2; art-bible §7.2.4 | Needed |
| E-042 | `env_camera_pole_medium.glb` | Prop-Security | Thin pole with camera head angled 45° down; painted metal grey `#4a4a40`; 4 instances at facades | street-view §3.2; art-bible §7.2.4 | Needed |

### Security — Militarised Tier

| # | Name | Type | Description | Source | Status |
|---|------|------|-------------|--------|--------|
| E-043 | `env_tank_large.glb` | Prop-Security | Dark olive `#2a3018` tank; 2 instances at opposing road ends pointing center | street-view §3.2; art-bible §7.2.4 | Needed |
| E-044 | `env_cannon_medium.glb` | Prop-Security | Field artillery on sidewalk, barrel facing facades; 4 instances | street-view §3.2; art-bible §7.2.4 | Needed |
| E-045 | `env_gun_nest_medium.glb` | Prop-Security | Sandbag U-shape `#7a6a50` at road center; 2 instances | street-view §3.2; art-bible §7.2.4 | Needed |
| E-046 | `env_searchlight_large.glb` | Prop-Security | Drum-mount on tripod; animated PointLight `#d0e0ff` i=1.2 d=6; Y-rotation ~0.5 rad/s; 2 instances | street-view §3.2; art-bible §7.2.4, §5.4.4 | Needed |
...
| # | Name | Type | Description | Source | Status |
|---|------|------|-------------|--------|--------|
| E-049 | `env_statue_bronze_standing_large.glb` | Prop-Statue | Bronze dictator standing; `#7a5c28`; plaque "HE WAS PRESENT"; Shop tier 100 | street-view §3.2; art-bible §7.2.5 | Needed |
| E-050 | `env_statue_silver_equestrian_large.glb` | Prop-Statue | Silver equestrian on horse; `#9090a0`; plaque "HE WAS PRESENT TWICE"; Shop tier 150 | street-view §3.2; art-bible §7.2.5 | Needed |
| E-051 | `env_statue_gold_triumph_large.glb` | Prop-Statue | Golden horse + woman + crushed bureaucrats; `#c0a000` emissive `#6a5000`; plaque "HISTORY BEGAN ON HIS BIRTHDAY"; Shop tier 200 | street-view §3.2; art-bible §7.2.5 | Needed |
...
> These are design-named slots only. No GLB filenames assigned. Requires naming before pipeline intake.
...
|---|-------------|------|-------------|--------|--------|
| V-001 | Fire Plane (Burning Trash Can) | VFX-AnimatedUV | `THREE.PlaneGeometry`; UV-scroll `MeshToonMaterial`; 4-frame vertical strip 256×1024; 10fps (`map.offset.y += 0.25`); double-sided | art-bible §9.1, §7.2.3 | Needed |
| V-002 | Searchlight Sweep | VFX-LightAnimation | PointLight `#d0e0ff` i=1.2; position vector rotates ~0.5 rad/s around Y; one per `env_searchlight_large.glb`; only animated light in game | art-bible §9.2, §5.4.4 | Needed |
...
| V-008 | Trash-Can PointLight Fill | VFX-Light | PointLight `#ff4400` i=0.8 d=3 per `env_trash_can_burning_small.glb`; ambient scene illumination at Poor tier | art-bible §5.4.1, §7.2.3 | Needed |
| V-009 | Standard Streetlight PointLight | VFX-Light | PointLight `#c87820` i=0.6 d=4 per `env_streetlight_standard_medium.glb` | art-bible §5.4.2, §7.2.3 | Needed |
| V-010 | Luxury Streetlight PointLight | VFX-Light | PointLight `#c87820` i=0.7 d=4.5 per `env_streetlight_luxury_medium.glb` | art-bible §7.2.3 | Needed |
...
|---|------------|------|-------------|--------|--------|
| SP-037 | `env_fire_trash_strip_256x1024.png` | Sprite-AnimSheet | 256×1024 total; 4 frames at 256×256; vertical strip; sRGB; UV-scroll map for trash-can fire plane | art-bible §9.1, §10.3 | Needed |
...
| SP-040 | `assets/fonts/Bitmgothic.ttf` | Font | Loaded but not yet in use; reserved/alternate | art-bible §3 | Existing |
...
2. **Weird Law/Deal props (S-006 — S-020)** — All Sprint 5 stubs; need GLB names and visual briefs before `/asset-spec` can generate specs for them.
3. **`entities.yaml` / `entities.md`** — citizen-simulation.md references an entity registry; no such file was found. Superseded by this inventory, or does the registry still need to be created?
4. **Skin tone material variants** — 5 skin tone values per citizen ped are material-level only (no separate meshes). Confirmed not separate inventory entries.
5. **Elimination animation props** (trap door, cane, crane) — Forward requirements documented in art-bible §7.1.3; not Sprint 5 scope. Not included as active inventory items.
